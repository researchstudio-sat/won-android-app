...
import at.researchstudio.sat.won.android.won_android_app.app.adapter.MenuItemAdapter;
...
public class NavigationDrawerFragment extends Fragment {
    //TODO: PREVENT NAVIGATION DRAWER FROM BEING OPENED VIA SWIPE WITHIN SUBPAGES (every page with a backbutton)
    /**
    ...
    /*
     * Method that invokes certain menuitem changes and updates after a menuitem was selected
     *  */
    ...
    public void deselectAllMenuItems(){
        for(int i=0; i < mMenuItemAdapter.getCount(); i++) {
            ((MenuItemModel) mMenuItemAdapter.getItem(i)).setSelected(false);
        }
    }
